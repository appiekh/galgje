...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["eigenWoord"])) {
    $userWord = $_POST["eigenWoord"];
    $_SESSION['randomWord'] = $userWord;
...
<body>
    ...
    <div>
        <a href="../php/galgje.php">Vul een nieuw woord in</a>
    </div>
